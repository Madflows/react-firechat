            ...
            >
              ...
              <div className="flex gap-3 flex-col md:flex-row">
                <button
                  ...
                  className="rounded shadow-md pl-6 pr-8 py-3 bg-slate-200 hover:bg-slate-300 text-gray-600 font-medium flex items-center justify-center overflow-y-hidden focus:outline-none focus:ring focus:ring-primary-500 focus:ring-opacity-75"
                >
                  <svg
                    viewBox="5 -5 30 30"
                ...
                <button
                  ...
                  className="rounded shadow-md pl-6 pr-8 py-3 bg-slate-200 hover:bg-slate-300 text-gray-600 font-medium flex items-center justify-center overflow-y-hidden focus:outline-none focus:ring focus:ring-primary-500 focus:ring-opacity-75"
                >
                  <FaGithub className="w-6 h-6 mr-4 flex-shrink-0" />
                  Sign in with Github
                </button>
              </div>
            </div>
